...
// --output=./system-parachains/bridge-hubs/bridge-hub-polkadot/src/weights/snowbridge_pallet_outbound_queue.rs
...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue::WeightInfo for WeightInfo<T> {
	...
	fn do_process_message() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `3513`
		// Minimum execution time: 42_410_000 picoseconds.
	...
	fn commit() -> Weight {
		...
		Weight::from_parts(33_260_000, 0)
			.saturating_add(Weight::from_parts(0, 2517))
	...
	fn commit_single() -> Weight {
		...
		Weight::from_parts(10_410_000, 0)
			.saturating_add(Weight::from_parts(0, 1524))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
