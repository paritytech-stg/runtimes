...
// --output=./system-parachains/bridge-hubs/bridge-hub-polkadot/src/weights/pallet_bridge_parachains.rs
...
impl<T: frame_system::Config> pallet_bridge_parachains::WeightInfo for WeightInfo<T> {
	...
	fn submit_parachain_heads_with_n_parachains(_p: u32, ) -> Weight {
		...
		//  Measured:  `230`
		//  Estimated: `2543`
		// Minimum execution time: 48_910_000 picoseconds.
		Weight::from_parts(52_439_975, 0)
