...
// --output=./system-parachains/bridge-hubs/bridge-hub-polkadot/src/weights/pallet_balances.rs
...
impl<T: frame_system::Config> pallet_balances::WeightInfo for WeightInfo<T> {
	...
	fn transfer_keep_alive() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `3593`
		// Minimum execution time: 55_670_000 picoseconds.
	...
	fn transfer_all() -> Weight {
		...
		Weight::from_parts(71_200_000, 0)
			.saturating_add(Weight::from_parts(0, 3593))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn upgrade_accounts(u: u32, ) -> Weight {
		...
		Weight::from_parts(22_680_000, 0)
			...
			// Standard Error: 13_761
			.saturating_add(Weight::from_parts(19_503_397, 0).saturating_mul(u.into()))
